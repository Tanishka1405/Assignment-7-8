document.addEventListener('DOMContentLoaded', function() {
    ...
    const player1ScoreShow = document.getElementById('player1-score');
    const player2ScoreShow = document.getElementById('player2-score');
    ...
    function updateScore() {
        player1ScoreShow.textContent = `Player 1 Score: ${player1Score}`;
        player2ScoreShow.textContent = `Player 2 Score: ${player2Score}`;
    }
